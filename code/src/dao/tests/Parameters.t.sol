...
contract TestParametersOffchain is Test {
    ...
    function _parameterValue(
        Parameters.ParameterTypes parameter
    ) internal view returns (uint256) {
        if (parameter == Parameters.ParameterTypes.maximumWhitelistedPools)
            return poolsConfig.maximumWhitelistedPools();
        if (
            parameter ==
            Parameters.ParameterTypes.maximumInternalSwapPercentTimes1000
            ...
            parameter ==
            Parameters.ParameterTypes.rewardsEmitterDailyPercentTimes1000
        ) return rewardsConfig.rewardsEmitterDailyPercentTimes1000();
        else if (
            parameter ==
            Parameters.ParameterTypes.emissionsWeeklyPercentTimes1000
            ...
            parameter ==
            Parameters.ParameterTypes.rewardPercentForCallingLiquidation
        ) return stableConfig.rewardPercentForCallingLiquidation();
        else if (
            parameter ==
            Parameters.ParameterTypes.maxRewardValueForCallingLiquidation
        ) return stableConfig.maxRewardValueForCallingLiquidation();
        else if (
            parameter ==
            Parameters.ParameterTypes.minimumCollateralValueForBorrowing
        ) return stableConfig.minimumCollateralValueForBorrowing();
        else if (
            parameter == Parameters.ParameterTypes.initialCollateralRatioPercent
        ) return stableConfig.initialCollateralRatioPercent();
        else if (
            parameter == Parameters.ParameterTypes.minimumCollateralRatioPercent
        ) return stableConfig.minimumCollateralRatioPercent();
        else if (
            parameter ==
            Parameters.ParameterTypes.percentArbitrageProfitsForStablePOL
            ...
            parameter ==
            Parameters.ParameterTypes.baseBallotQuorumPercentTimes1000
            ...
            parameter ==
            Parameters.ParameterTypes.requiredProposalPercentStakeTimes1000
        ) return daoConfig.requiredProposalPercentStakeTimes1000();
        else if (
            parameter ==
            Parameters.ParameterTypes.maxPendingTokensForWhitelisting
        ) return daoConfig.maxPendingTokensForWhitelisting();
        else if (
            parameter == Parameters.ParameterTypes.arbitrageProfitsPercentPOL
            ...
            parameter ==
            Parameters.ParameterTypes.maximumPriceFeedPercentDifferenceTimes1000
    ...
    function _checkParameter(
        ...
        assertEq(
            ...
            defaultValue,
            "Default value is not as expected"
        );

        // Try increasing once
        parameters.executeParameterChange(
            parameter,
            true,
            poolsConfig,
            stakingConfig,
        ...
        if (expectedAfterIncrease > maxValue) expectedAfterIncrease = maxValue;

        assertEq(
            _parameterValue(parameter),
            expectedAfterIncrease,
            "Increased value is not as expected"
        );
        ...
        if (expectedAfterDecrease < minValue) expectedAfterDecrease = minValue;

        assertEq(
            _parameterValue(parameter),
            expectedAfterDecrease,
            "Decreased value is not as expected"
        );
        ...
        while (true) {
            ...
            if (_parameterValue(parameter) >= maxValue) break;
        }
        ...
        while (true) {
            ...
            if (_parameterValue(parameter) <= minValue) break;
        }
    ...
    function testPoolParameters() public {
        ...
        _checkParameter(
            Parameters.ParameterTypes.maximumWhitelistedPools,
            20,
            50,
            100,
            10
    ...
    function testStakingParameters() public {
        ...
        _checkParameter(
            Parameters.ParameterTypes.maxUnstakeWeeks,
            20,
            52,
            108,
            8
        ...
        _checkParameter(
            Parameters.ParameterTypes.minUnstakePercent,
            10,
            20,
            50,
            5
        ...
        _checkParameter(
            Parameters.ParameterTypes.modificationCooldown,
            15 minutes,
            1 hours,
            6 hours,
            15 minutes
    ...
    function testRewardsParameters() public {
        ...
        _checkParameter(
            Parameters.ParameterTypes.stakingRewardsPercent,
            25,
            50,
            75,
            5
        ...
        _checkParameter(
            Parameters.ParameterTypes.percentRewardsSaltUSDS,
            5,
            10,
            25,
            5
    ...
    function testStableParameters() public {
        ...
        _checkParameter(
            Parameters.ParameterTypes.initialCollateralRatioPercent,
            150,
            200,
            300,
            25
        ...
        _checkParameter(
            Parameters.ParameterTypes.minimumCollateralRatioPercent,
            110,
            110,
            120,
            1
    ...
    function testDAOParameters() public {
        vm.startPrank(address(parameters));
        _checkParameter(
            Parameters.ParameterTypes.bootstrappingRewards,
            50000 ether,
            200000 ether,
            500000 ether,
            50000 ether
        ...
        _checkParameter(
            Parameters.ParameterTypes.percentPolRewardsBurned,
            25,
            50,
            75,
            5
        ...
        _checkParameter(
            Parameters.ParameterTypes.ballotDuration,
            3 days,
            10 days,
            14 days,
            1 days
        ...
        _checkParameter(
            Parameters.ParameterTypes.arbitrageProfitsPercentPOL,
            15,
            20,
            45,
            5
        ...
        _checkParameter(
            Parameters.ParameterTypes.upkeepRewardPercent,
            1,
            5,
            10,
            1
    ...
    function testPriceAggregatorParameters() public {
        ...
        _checkParameter(
            Parameters.ParameterTypes.setPriceFeedCooldown,
            30 days,
            35 days,
            45 days,
            5 days
